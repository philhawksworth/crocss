...
export default function Layout({ name, imageUrl, slug, colors, guess }: { name: string; imageUrl: string; slug: string; colors: string[]; guess: string | null }) {
  return `
  ...
  ${
    guess
      ? `<p>So you think this Croc's hex code is</p><div class="guess"> ${
        swatch(guess)
      }</div><p>Brag about how close you were by sharing this URL: <br><code>https://crocss.philhawksworth.dev/croc/${slug}/guess/${guess}</code></p><p>or guess again?</p>`
      : ""
  }
